namespace SharpShadowsToolkit
{
    public static class Docs
    {
        public static class Tooltip
        {
            ...
            public const string NearExtrusionDistance = "The amount to extrude the part of the shadow volume facing towards the light";

            public const string FarExtrusionDistance = "The amount to extrude the part of the shadow volume facing away from the light";
